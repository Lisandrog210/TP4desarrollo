...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/images/diagdown.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/diagup.png", "assets/images/diagup.png");
			type.set ("assets/images/diagup.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/north.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/side.png", "assets/images/side.png");
			type.set ("assets/images/side.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/south.png", "assets/images/south.png");
			type.set ("assets/images/south.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/south2.png", "assets/images/south2.png");
			type.set ("assets/images/south2.png", Reflect.field (AssetType, "image".toUpperCase ()));
