...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/data/lvl1.oep");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("assets/images/blueSlime.png");
		...
		urls.push ("assets/images/character1.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/greenSlime.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/gun.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/images/purpleSlime.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/redSlime.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/square.png");
		types.push (lime.Assets.AssetType.IMAGE);
