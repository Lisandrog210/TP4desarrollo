...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/blueSlime.png", __ASSET__assets_images_blueslime_png);
		type.set ("assets/images/blueSlime.png", AssetType.IMAGE);
		className.set ("assets/images/boss.png", __ASSET__assets_images_boss_png);
		type.set ("assets/images/boss.png", AssetType.IMAGE);
		className.set ("assets/images/character1.png", __ASSET__assets_images_character1_png);
		type.set ("assets/images/character1.png", AssetType.IMAGE);
		className.set ("assets/images/greenSlime.png", __ASSET__assets_images_greenslime_png);
		type.set ("assets/images/greenSlime.png", AssetType.IMAGE);
		className.set ("assets/images/gun.png", __ASSET__assets_images_gun_png);
		type.set ("assets/images/gun.png", AssetType.IMAGE);
		className.set ("assets/images/player.png", __ASSET__assets_images_player_png);
		type.set ("assets/images/player.png", AssetType.IMAGE);
		className.set ("assets/images/purpleSlime.png", __ASSET__assets_images_purpleslime_png);
		type.set ("assets/images/purpleSlime.png", AssetType.IMAGE);
		className.set ("assets/images/redSlime.png", __ASSET__assets_images_redslime_png);
		type.set ("assets/images/redSlime.png", AssetType.IMAGE);
		className.set ("assets/images/square.png", __ASSET__assets_images_square_png);
		type.set ("assets/images/square.png", AssetType.IMAGE);
		...
		type.set (id, AssetType.TEXT);
		id = "assets/images/blueSlime.png";
		path.set (id, id);
		...
		type.set (id, AssetType.IMAGE);
		id = "assets/images/greenSlime.png";
		path.set (id, id);
		...
		type.set (id, AssetType.IMAGE);
		id = "assets/images/purpleSlime.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/redSlime.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/square.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_data_lvl1_oel extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_lvl1_oep extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_images_blueslime_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_character1_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_greenslime_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_gun_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_purpleslime_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_redslime_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_square_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/images/blueSlime.png") #if display private #end class __ASSET__assets_images_blueslime_png extends lime.graphics.Image {}
@:image("assets/images/boss.png") #if display private #end class __ASSET__assets_images_boss_png extends lime.graphics.Image {}
@:image("assets/images/character1.png") #if display private #end class __ASSET__assets_images_character1_png extends lime.graphics.Image {}
@:image("assets/images/greenSlime.png") #if display private #end class __ASSET__assets_images_greenslime_png extends lime.graphics.Image {}
@:image("assets/images/gun.png") #if display private #end class __ASSET__assets_images_gun_png extends lime.graphics.Image {}
...
@:image("assets/images/purpleSlime.png") #if display private #end class __ASSET__assets_images_purpleslime_png extends lime.graphics.Image {}
@:image("assets/images/redSlime.png") #if display private #end class __ASSET__assets_images_redslime_png extends lime.graphics.Image {}
@:image("assets/images/square.png") #if display private #end class __ASSET__assets_images_square_png extends lime.graphics.Image {}
